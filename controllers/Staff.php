...
class Staff extends AdminController
{
    ...
    public function member($id = '')
    {
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                if ($id) {
                    ...
                    redirect(admin_url('pengguna/staff/member/' . $id));
                }
            } else {
        ...
        //$this->load->view('admin/pengguna/staff/member', $data);
        $this->load->view('admin/pengguna/staff/member', $data);
        //$this->load->view(module_views_path('pengguna','admin/pengguna/member'), $data);
    }
    ...
    public function timesheets()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->app->get_table_data(module_views_path('pengguna','staff_timesheets', ['view_all' => $data['view_all']]));
        }
        ...
        $data['title']       = '';
        $this->load->view('admin/pengguna/staff/timesheets', $data);
    }
    ...
    public function delete()
    {
        ...
        redirect(admin_url('pengguna/staff'));
    }
    ...
    public function edit_profile()
    {
        ...
        if ($this->input->post()) {
            ...
            redirect(admin_url('pengguna/staff/edit_profile/' . get_staff_user_id()));
        }
        ...
        $this->load->view('admin/pengguna/staff/profile', $data);
    }
    ...
    public function remove_staff_profile_image($id = '')
    {
        ...
        if (!is_numeric($id)) {
            redirect(admin_url('pengguna/staff/edit_profile/' . $staff_id));
        } else {
            redirect(admin_url('pengguna/staff/member/' . $staff_id));
        }
    }
    ...
    public function change_password_profile()
    {
        if ($this->input->post()) {
            ...
            redirect(admin_url('pengguna/staff/edit_profile'));
        }
    }
    ...
    public function profile($id = '')
    {
        ...
        $this->load->view('admin/pengguna/staff/myprofile', $data);
    }
            ...
            foreach ($notifications as $notification) {
                if (($notification['fromcompany'] == null && $notification['fromuserid'] != 0) || ($notification['fromcompany'] == null && $notification['fromclientid'] != 0)) {
                    if ($notification['fromuserid'] != 0) {
                        $notifications[$i]['profile_image'] = '<a href="' . admin_url('pengguna/staff/profile/' . $notification['fromuserid']) . '">' . staff_profile_image($notification['fromuserid'], [
    ...
    {
        if (
            !has_permission('pengguna', '', 'view')
            && !has_permission('pengguna', '', 'view_own')
            && get_option('allow_staff_view_pengguna_assigned') == 0
        ) {
            ajax_access_denied();
        }
        $this->app->get_table_data(module_views_path('pengguna', 'tables/staff'));
    }
}
